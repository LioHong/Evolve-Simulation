# -*- coding: utf-8 -*-
"""
Filename: familytreemaker_child_to_parents.py
Date created: 2022/08/27, Sat, 11:13:30 (UTC+8)
@author: Julio Hong
Purpose: Modify the below repo to accept individuals in the format "Person, Parent1, Parent2".
